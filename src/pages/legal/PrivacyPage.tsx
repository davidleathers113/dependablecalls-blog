        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              For detailed information about our cookie practices, please review our <Link to="/cookies" className="text-primary-600 hover:text-primary-700 font-medium">Cookie Policy</Link>.
            </p>
          </section>
